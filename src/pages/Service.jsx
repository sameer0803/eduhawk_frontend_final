...
// //             Eduhawk is one powerful online software suite that combines all the tools needed to run a
...
// //               <div className="absolute -top-10 left-1/2 -translate-x-1/2 w-20 h-20 bg-blue-500 rounded-full flex items-center justify-center">
// //                 <svg className="w-8 h-8 text-white" viewBox="0 0 24 24" fill="currentColor">
// //                   <path d="M20 8H4V6H20V8ZM18 4H6V2H18V4ZM22 12H2V10H22V12Z" />
// //                 </svg>
// //               </div>
...
// //             {/* Card 2 */}
// //             <div className="bg-white rounded-2xl shadow-xl p-8 text-center relative">
// //               <div className="absolute -top-10 left-1/2 -translate-x-1/2 w-20 h-20 bg-orange-500 rounded-full flex items-center justify-center">
// //                 <svg className="w-8 h-8 text-white" viewBox="0 0 24 24" fill="currentColor">
// //                   <path d="M19 4H5C3.9 4 3 4.9 3 6V18C3 19.1 3.9 20 5 20H19C20.1 20 21 19.1 21 18V6C21 4.9 20.1 4 19 4ZM5 18V8H19V18H5Z" />
// //                 </svg>
// //               </div>
// //               <h3 className="text-xl font-semibold text-[#2F327D] mt-6 mb-4">
...
// //             {/* Card 3 */}
// //             <div className="bg-white rounded-2xl shadow-xl p-8 text-center relative">
// //               <div className="absolute -top-10 left-1/2 -translate-x-1/2 w-20 h-20 bg-cyan-500 rounded-full flex items-center justify-center">
// //                 <svg className="w-8 h-8 text-white" viewBox="0 0 24 24" fill="currentColor">
...
// //               </h3>
// //               <p className="text-gray-600">
// //                 Automate and track emails to individuals or groups. Eduhawk’s built-in system helps
...
// //             Eduhawk has every tool your classroom needs and comes pre-integrated with more than
...
// //             {['Google Drive', 'Dropbox', 'OneDrive', 'Google Classroom', 'Microsoft Teams', 'Zoom'].map(
// //               (name) => (
// //                 <div key={name} className="text-center">
// //                   <div className="w-16 h-16 mx-auto bg-gray-100 rounded-xl flex items-center justify-center mb-3">
// //                     <span className="text-gray-500 text-xs font-medium">{name[0]}</span>
// //                   </div>
...
// //               Eduhawk has got more than 100k positive ratings from our users around the world.
// //             </p>
// //             <p className="text-gray-600 mb-6">
// //               Some of the students and teachers were greatly helped by the Eduhawk.
// //             </p>
// //             <p className="text-gray-600 mb-8">Are you too? Please give your assessment</p>
...
// //                 weren't wrong, Eduhawk has been ticking all the boxes!"
// //               </p>
...
// //                 </p>
// //                 <a href="#" className="text-[#F48C06] font-medium hover:underline">
// //                   Read more →
// //                 </a>
// //               </div>
// //             </div>
...
// //         {/* ────────────────────────────────────────────────
// //             TOOLS FOR TEACHERS & LEARNERS (last big section)
// //         ──────────────────────────────────────────────── */}
...
// //                 <div className="w-12 h-12 bg-white shadow-lg rounded-xl flex items-center justify-center flex-shrink-0">
// //                   <div className="w-6 h-6 bg-[#2F327D] rounded-sm"></div>
// //                 </div>
...
// //               <div className="flex gap-4">
// //                 <div className="w-12 h-12 bg-white shadow-lg rounded-xl flex items-center justify-center flex-shrink-0">
// //                   <div className="w-8 h-8 bg-[#F48C06] rounded-md"></div>
// //                 </div>
// //                 <p className="text-gray-700">
...
// //                     <div className="w-3 h-3 bg-[#2F327D] rounded-sm"></div>
// //                     <div className="w-3 h-3 bg-[#2F327D] rounded-sm"></div>
// //                     <div className="w-3 h-3 bg-[#2F327D] rounded-sm"></div>
// //                     <div className="w-3 h-3 bg-[#F48C06] rounded-sm"></div>
// //                   </div>
// //                 </div>
// //                 <p className="text-gray-700">
...
// //             <div className="absolute -top-6 -left-6 w-32 h-32 bg-green-400 rounded-full blur-2xl opacity-40 animate-pulse"></div>
// //             <div className="absolute -bottom-8 -right-8 w-40 h-40 bg-yellow-400 rounded-full blur-2xl opacity-30 animate-pulse delay-1000"></div>
// //           </div>
// //         </section>
// //       </main>
...
// // App.jsx (or wherever this component lives)
...
//         {/* ... (Integrations and Testimonial sections remain the same) ... */}

//         {/* TOOLS FOR TEACHERS & LEARNERS - with enhanced floating blobs */}
//         <section className="grid lg:grid-cols-2 gap-16 items-center">
//           <div className="space-y-8">
//             <h2 className="text-4xl md:text-5xl font-bold text-[#2F327D]">
//               <span className="text-[#F48C06]">Tools</span> For Teachers And Learners
...
//                   <svg className="w-7 h-7 text-[#2F327D]" viewBox="0 0 24 24" fill="currentColor">
...
//                   <svg className="w-7 h-7 text-[#F48C06]" viewBox="0 0 24 24" fill="currentColor">
...
//             {/* Enhanced floating blobs with different animations */}
...
//       {/* Footer placeholder remains the same */}

//       {/* Add these global animations (put in your global CSS or inside <style jsx global> if using Next.js) */}
//       <style jsx global>{`
...
//         }
//         .animate-float-card:nth-child(2) { animation-delay: 1s; }
//         .animate-float-card:nth-child(3) { animation-delay: 2s; }
...
//         }
//         .animate-float-icon.delay-200 { animation-delay: 0.8s; }
//         .animate-float-icon.delay-400 { animation-delay: 1.6s; }
...
//         .animate-float-medium { animation: float-medium 9s ease-in-out infinite; animation-delay: 1.5s; }
//         .animate-float-fast { animation: float-fast 7s ease-in-out infinite; animation-delay: 3s; }
//       `}</style>
//     </div>
//   );
// }
