...
//                   <button className="border-2 border-white/70 text-white font-semibold px-10 py-5 rounded-xl hover:bg-white/10 transition-all duration-300 text-lg" onClick={downloadPDF}>
//                     Learn More
//                   </button>
//                 </div>
//               </div>
...
//               <p>
//                 We understand the complex world of college admissions and the
//                 challenges students and families face. Our mission is to
//                 demystify this process by providing personalized guidance...
//               </p>
//               <p>
//                 We're here to guide you through every decision — big or small —
//                 on the path to college success...
//               </p>
//               <p className="font-medium">
//                 Together, we turn the challenge of college admissions into an
//                 opportunity for growth, learning, and success.
//               </p>
...
//               Quick answers to the most common questions about MBBS abroad with
//               EDU HAWK
//             </p>
//           </div>
...
//                 <br className="hidden lg:block" /> College Counseling Done Right
//               </h3>
//             </div>
//           </div>
//         </div>
